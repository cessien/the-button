...
$(STATIC_APP): button.c
	$(CC) button.c -o $(STATIC_APP) libc/d2xx/darwin/libftd2xx.a $(CFLAGS) $(DEPENDENCIES)

$(DYNAMIC_APP): button.c
	$(CC) button.c -o $(DYNAMIC_APP) $(CFLAGS) -lftd2xx $(DEPENDENCIES) $(DYNAMIC_LINK_OPTIONS)
